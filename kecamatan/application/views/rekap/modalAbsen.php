...
<div class="box" style='max-width:1200px;margin-left:90px;'>
    <div class="box-header with-border">
        <h3 class="box-title">Data Absensi Karyawan </h3> <br>
        <center></center><button type="button" class="btn btn-danger btn3d pull-right" data-dismiss="modal"><i class='fa fa-close'></i>Close</button>
                    ...
                    <table style='margin-left:70px;'>
                        <tr>
                            <td style='padding:50px'>
                                <img src="<?php echo base_url(); ?>assets/dist/img/kotabaru.png" width='100px'></img>
                            </td>
                            <td> <br>
                        ...
                        <thead>
                            ...
                            <tr style='background-color:#42f445 !important'>
                                ...
                                foreach ($resultHadir as $data) {
                                    ...
                                    if ($days == "M") {
                                        echo "<th class='sunday' style='text-align:center;color:red !important;width:40px;'>" . ($days) . "</th>";
                                    } else {
