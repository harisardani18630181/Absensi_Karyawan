...
<head>
	...
	<title>Kelumpang Utara</title>
	<link rel="icon" href="dist/img/Kotabaru.png">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/Kotabaru.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
			
				<span class="brand-text"><br>KELURAHAN DESA PUDI</span>
			</a>
